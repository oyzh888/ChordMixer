...
import midi.midi.event.MidiEvent;
import midi.midi.event.NoteOff;
import midi.midi.event.NoteOn;
import midi.midi.event.meta.EndOfTrack;
import midi.midi.event.meta.Tempo;
import midi.midi.event.meta.TimeSignature;
import midi.midi.util.MidiUtil;
import midi.midi.util.VariableLengthInt;
...
public class MidiTrack
{
    ...
    public void insertNote(int channel, int pitch, int velocity, long tick, long duration)
    {
        ...
        //insertEvent(new NoteOff(tick+duration,channel,pitch,velocity));
        //VIP
    }
